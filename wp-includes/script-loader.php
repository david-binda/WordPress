...
function wp_default_scripts( $scripts ) {
	...
	if ( is_admin() ) {
		...
		$scripts->add( 'site-health', "/wp-admin/js/site-health$suffix.js", array( 'clipboard', 'jquery', 'wp-util', 'wp-a11y', 'wp-api-request', 'wp-url', 'wp-i18n', 'wp-hooks' ), false, 1 ); // Core Hack.
